...
public class GoodsImageReader {
	...
	public String[] read(String folder,String goodsid,String excludeStr ){
		...
		for(String imgname: imgNames){
			...
			FileUtil.copyFile(sourcePath,  static_server_path+"/attachment/goods/"+goodsid+"/"+imgname);
	...
	private String getThumbPath(String filename,String shortName,String goodsid){
		String name  =StaticResourcesUtil.getThumbPath(filename, shortName);
		String static_server_path= SystemSetting.getStatic_server_path();
