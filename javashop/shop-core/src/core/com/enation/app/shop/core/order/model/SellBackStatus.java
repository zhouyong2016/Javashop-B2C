...
public enum SellBackStatus  {
	apply("申请退货",0),in_storage("退货入库",1),all_storage("全部入库",4),cancel("取消退货",2),some_storage("部分入库",5),refund("已退款",6),wait("等待审核",0),pass("审核通过",1),refuse("审核拒绝",2),application("等待退款",3);
