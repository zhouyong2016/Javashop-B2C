...
;!function (a) {
    "use strict";
    var b   = document, c = "querySelectorAll", d = "getElementsByClassName", e = function (a) {return b[c](a)}, f = {
        type      : 0,
        shade     : !0,
        shadeClose: !0,
        fixed     : !0,
    ...
    j.prototype.view = function () {
        ...
        close   : function (a) {
            var c                                                               = e("#" + i[0] + a)[0];
            var layershade                                                      = c.getElementsByClassName('layui-m-layershade')[0];
            var animUp                                                          = c.getElementsByClassName('layui-m-anim-up')[0];
            animUp.style.top                                                    = '800px';
            animUp.getElementsByClassName('layui-m-layercont')[0].style.opacity = 0;
            layershade.style.opacity                                            = 0;
            setTimeout(function () {c && (c.innerHTML = "", b.body.removeChild(c), clearTimeout(g.timer[a]), delete g.timer[a], "function" == typeof g.end[a] && g.end[a](), delete g.end[a])}, 300)
        },
        closeAll: function () {for (var a = b[d](i[0]), c = 0, e = a.length; e > c; c++)layer.close(0 | a[0].getAttribute("index"))}
    }, "function" == typeof define ? define(function () {return layer}) : function () {
...
}(window);/*! layer mobile-v2.0 弹层组件移动版 License LGPL http://layer.layui.com/mobile By 贤心 */
;!function (a) {
    "use strict";
    var b   = document, c = "querySelectorAll", d = "getElementsByClassName", e = function (a) {return b[c](a)}, f = {
        type      : 0,
    ...
    j.prototype.view = function () {
        ...
        close   : function (a) {
            ...
            var layershade  = c.getElementsByClassName('layui-m-layershade')[0];
            var animUp  = c.getElementsByClassName('layui-m-anim-up')[0];
            var seep = animUp ? 300 : 0;
            if(animUp){
                animUp.style.top  = '800px';
                animUp.getElementsByClassName('layui-m-layercont')[0].style.opacity = 0;
                layershade.style.opacity = 0;
            }
            setTimeout(function () {c && (c.innerHTML = "", b.body.removeChild(c), clearTimeout(g.timer[a]), delete g.timer[a], "function" == typeof g.end[a] && g.end[a](), delete g.end[a])}, seep)
        },
        closeAll: function () {for (var a = b[d](i[0]), c = 0, e = a.length; e > c; c++)layer.close(0 | a[0].getAttribute("index"))}
    }, "function" == typeof define ? define(function () {return layer}) : function () {
        var a = document.scripts, c = a[a.length - 1], d = c.src, e = d.substring(0, d.lastIndexOf("/") + 1);
