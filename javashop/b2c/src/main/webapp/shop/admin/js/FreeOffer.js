var FreeOffer=$.extend({},Eop.Grid,{
	...
	doDelete:function(){
		...
		this.deletePost("freeOffer!delete.do");
	...
	doClean:function(){
		...
		this.deletePost("freeOffer!clean.do");
	},
	...
	doRevert:function(){
		...
		this.deletePost("freeOffer!revert.do","选择的赠品已被成功还原至赠品列表中");		
	}
	
});

$(function(){
	FreeOffer.opation("idChkName","id");
	FreeOffer.init();
});