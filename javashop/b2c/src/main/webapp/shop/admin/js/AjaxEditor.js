...
(function($){
	...
	tpl+='</span>';
	tpl+='<span class="ipt"><input type="text" name="num"  /><a  class="save no-enable" href="javascript:;">保存</a><a  class="cancel" href="javascript:;">保存</a></span>';
	tpl+='</div>';
	...
	$.fn.AjaxEditor = function(saveurl,paramName,checker){
		 return this.each(function(){
			 ...
			 edit.find("a.save").click(function(){
				 var editlink=$(this);
