...
<table  class="form-table">
	<tr>
		...
		<td><input type="text" name="site.name" value="${site.name }" style="width:250px" dataType="string" isrequired="true" /><input type="hidden" name="site.siteid" value="${site.siteid }"/></td>
	</tr>
	<tr>
     ...
     <tr>
       ...
       <td><input type="text" name="site.domain" id="sitedomain"  value="${site.domain }"  dataType="string" isrequired="true"  style="width:250px"/></td>
     </tr>
