...
<table  class="form-table">
	<tr>
		...
		<td><input type="text" name="site.name"  dataType="string" isrequired="true" style="width:250px"/></td>
	</tr>
	<tr>
     ...
     <tr>
       ...
       <td><input type="text" name="site.domain" id="sitedomain"   dataType="string" isrequired="true"  style="width:250px"/></td>
     </tr>
      <tr>
