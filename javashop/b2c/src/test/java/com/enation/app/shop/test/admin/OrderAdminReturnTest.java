 ...
 * @version V1.0
 * @since  V6.0
 *2016年11月27日 上午10:21:39 
 */
public class OrderAdminReturnTest extends SpringTestSupport{
	...
	/*
	 * 已完成订单-后台退货申请测试:先创建一个完整的订单，然后后台进行退货申请
	 * @throws Exception
	 */
   @Test
   public void orderAdminReturnTest() throws Exception{
		...
		//后台进行退货申请
		mockMvc.perform(
				 MockMvcRequestBuilders.post("/shop/admin/sell-back/apply.do ")
				 .param("member_id", "1")
				 .param("orderId", ""+orderid)
				 .param("status", "1")
				 .param("tradeno", "148016982912")
				 .param("ordersn", "148016982912")
				 .param("sndto", "22")
				 .param("refund_way", "支付宝")
				 .param("ship_status", "1")
				 .param("reason", "商品质量有问题")
				 .param("return_account", "11111")
				 .param("apply_alltotal", "49.6")
				 .param("remark", "222222222")
				 .param("packDetailJson", "")
				 .param("goodsId", "267")
				 .param("item_id", "16")
				 .param("productId", "351")
				 .param("price", "39.6")
