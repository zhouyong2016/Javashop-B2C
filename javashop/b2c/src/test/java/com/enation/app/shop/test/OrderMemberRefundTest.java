 ...
 * @version V1.0
 * @since  V6.2
 *2016年11月27日 下午16:21:39 
 */
public class OrderMemberRefundTest extends SpringTestSupport {
	...
	/*
	 * 已完成订单-会员退款申请测试:先创建一个完整的订单，然后会员进行退款申请
	 * @throws Exception
	 */
	@Test
	public void orderCompleteRefundTest() throws Exception{
		...
		//会员对已完成订单进行退款申请
		mockMvc.perform(
				 MockMvcRequestBuilders.post("/api/shop/sell-back/return-money.do")
				 .param("orderid", ""+orderid)
				 .param("ship_status", "1")
				 .param("return_account", "111111111")
				 .param("reason", "买错/不想要")
   ...
   /*
    *已确认还未发货的订单-会员申请退款测试：先创建订单形成待发货状态，再进行退款申请
    *@throws Exception
    */
	@Test
	public void orderPayRefundTest() throws Exception{
