 ...
 * @version v1.0
 * @since v6.2
 * 2016年12月30日 上午12:58:04
 */
public class OrderMemberCommentTest extends SpringTestSupport {
	...
	/*
	 * 评论:先创建一个完整的订单，然后会员进行评论
	 * @throws Exception
	 */
	@Test
	public void orderCommentTest() throws Exception{
		...
		//会员对已完成订单进行评论
		mockMvc.perform(
				 MockMvcRequestBuilders.post("/api/shop/commentApi/addComment.do")
				 .param("commenttype","1" )
				 .param("product_id", "344")
				 .param("goods_id", "267")
				 .param("content", "商品挺好用的")
				 .param("grade_344", "3")
				 .param("orderid", ""+orderid)
				 .contentType(MediaType.APPLICATION_JSON)
				 .accept(MediaType.APPLICATION_JSON)
