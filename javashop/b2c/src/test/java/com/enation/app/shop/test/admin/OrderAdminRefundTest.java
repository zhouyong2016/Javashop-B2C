 ...
 */
public class OrderAdminRefundTest extends SpringTestSupport {
	...
	/*
	 * 已完成订单-后台退款申请测试:先创建一个完整的订单，然后后台进行退款申请
	 * @throws Exception
	 */
   @Test
   public void orderAdminRefundTest() throws Exception{
		...
		//后台进行退款申请
		mockMvc.perform(
				 MockMvcRequestBuilders.post("/shop/admin/sell-back/save-refund.do")
				 .param("orderid", ""+orderid)
				 .param("return_account", "2222")
