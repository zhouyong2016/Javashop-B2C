 ...
 */
public class OrderMemberCancleTest extends SpringTestSupport {
	...
	/*
	 * 在线支付、货到付款、银行转账，未付款订单-会员取消订单测试:会员提交订单，然后会员进行取消订单
	 * @throws Exception
	 */
	@Test
	public void orderNotpayCancleTest() throws Exception{
		...
		//创建订单
		 ...
		 //会员进行取消订单
		mockMvc.perform(
				 MockMvcRequestBuilders.post("/api/shop/order/cancel.do")
	...
	/*
	 * 货到付款   已付款未发货订单-会员取消订单测试:会员提交订单并付款，然后会员进行取消订单
	 * @throws Exception
	 */
	@Test
	public void orderPayCancleTest() throws Exception{
