 ...
 * 数据内容管理
 * 
 * @author kingapex 2010-7-5下午01:54:45
 */
public interface IDataManager {
	 ...
	 * @param modelid 模型ID
	 * @param connector  暂时未知（复制过来的）
	 * @param catid 分类id
	 * @return 分页对象
	 */
	public Page list(int pageNo, int pageSize, int modelid, String connector,
			String catid);
}
