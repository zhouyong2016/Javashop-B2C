...
public class WeixinUtil {
	...
	public static Document verifyCertPost(String wsPart, String doc_str,String mchid){
		try {
	        ...
	        FileInputStream instream = new FileInputStream(new File("/home/server/tomcat2/webapps/javamall/WEB-INF/classes/com/enation/app/shop/component/payment/plugin/weixin/cert/apiclient_cert.p12"));
